...
\authors{Ewan M. Pinnington\altaffilmark{1}, Eric Casella\altaffilmark{3}, Sarah L. Dance\altaffilmark{1,2}, Amos S. Lawless\altaffilmark{1,2,4}, James I. L. Morison\altaffilmark{3}, Nancy K. Nichols\altaffilmark{1,2,4}, Matthew Wilkinson\altaffilmark{3}, Tristan L. Quaife\altaffilmark{1,4}}
...
In Figures S1-S10 we present extra plots from the three experiments outlined in the paper (A, B \& C), we also add plots for a fourth experiment (labelled experiment D here) where only LAI, leaf mass per area and woody biomass are assimilated with the DALEC2 model.
