...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Model-data differences for the four experiments averaged across the fourteen years of each model forecast of NEE.}\label{fig:broke4dvar}
\end{figure}
