...
\subsection{DALEC1 state estimation} \label{chap5:sec:D1observability}
...
\subsection{Information content for a single observation} \label{chap5:sec:info_con_single_time}
