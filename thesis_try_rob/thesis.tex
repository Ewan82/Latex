\input{preface/begin}  %format document
...
\label{chap:aims}
\input{chapter/chapter2/aims}

\chapter{Current state of data assimilation for the carbon cycle}
\label{chap:litrev}
\input{chapter/chapter3/chapter3}

\chapter{Model and data}
\label{chap:data}
\input{chapter/chapter4/chapter4}
...
\input{chapter/chapter7/chapter7}
