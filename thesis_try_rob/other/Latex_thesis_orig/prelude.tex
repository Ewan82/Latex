...
\begin{flushright}
  \vspace{-2cm}
\includegraphics[width=50mm]{PLOTS/reading_logo.png} % {PLOTS/reading_logo.png} also available for if using PDFLaTeX
\end{flushright}
\end{figure}
\end{flushright}
\begin{flushleft}
...
%\begin{flushleft}
%  \vspace{1cm}
%\includegraphics[width=141mm]{PLOTS/titlepage_wording.eps} %
%\end{flushleft}
%\end{figure}
\Huge{\bf{Snow}}\\
